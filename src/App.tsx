...
import redmineFetcher, { Redmine } from './utils/redmineFetcher'
...
const redmineForm = () => {
    const [data, setData] = useState<Redmine | null>(null)
    ...
    const handleSubmit = async () => {
        ...
        const data = await redmineFetcher(id)
        setData(data)
    }
    return (
        <>
    ...
    return (
        ...
        >
            ...
            <div className="staging">
                <p>develop to stagingのPRの番号をいれて</p>
                <input onChange={handlePrInputChange}></input>
                <Button onClick={fetchData}>PRから取得</Button>
            </div>
